...
public class PGPHandshakeExtension implements PacketExtension {
	 ...
	 * Always returns "olapgphandshake"
	 * 
	 * @return the XML element name of the packet extension.
	 */
	@Override
	public String getElementName() {
		return "olapgphandshake";
	}
	...
	public String getNamespace() {
		return "http://olamedia.ru/jabber/pgp/handshake";
	}
